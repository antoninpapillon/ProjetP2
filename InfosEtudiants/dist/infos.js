...
var display_info_1 = __webpack_require__(34);
var info_1 = __webpack_require__(35);
var InfoState = /** @class */ (function () {
    function InfoState(props) {
        this.infos = [];
    }
    return InfoState;
}());
var InfoEleves = /** @class */ (function (_super) {
    __extends(InfoEleves, _super);
    function InfoEleves(props) {
        var _this = _super.call(this, props) || this;
        _this.state = new InfoState(props);
        return _this;
    }
    // Chargement des données en dur pour le moment, les données JSON seront importées d'ici ultérieurement
    InfoEleves.prototype.componentDidMount = function () {
        this.setState({
            infos: [({
                    code: "056558",
                    bac: "S",
    ...
    InfoEleves.prototype.buildRows = function (infos) {
        var j = 0, rows = [];
        for (var u = 0; u < infos.length; u++) {
            rows[j] = new info_1.Info(infos[u].code, infos[u].bac, infos[u].nom, infos[u].prenom, infos[u].option, infos[u].alternant, infos[u].lv2);
            j++;
        }
        return rows;
    };
    InfoEleves.prototype.render = function () {
        var rows = this.buildRows(this.state.infos);
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement("img", { src: "", alt: "" }),
                React.createElement("h2", null, "Informations")),
            rows && rows.map(function (row) {
                // Pour chaque note dans la liste de notes, ajout d'une ligne dans la grille avec les valeurs de la note
                return (React.createElement(display_info_1.DisplayInfo, { row: row, key: row.code }));
            })));
    };
    return InfoEleves;
}(React.Component));
exports.InfoEleves = InfoEleves;
ReactDom.render(React.createElement(InfoEleves, null), document.getElementById("infos"));
...
exports.__esModule = true;
var React = __webpack_require__(2);
var DisplayInfoState = /** @class */ (function () {
    function DisplayInfoState(props) {
    }
...
var DisplayInfo = /** @class */ (function (_super) {
    ...
    function DisplayInfo(props) {
        var _this = _super.call(this, props) || this;
        _this.state = new DisplayInfoState(props);
        return _this;
    }
    DisplayInfo.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "block" },
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " Code : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.code.toString())),
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " Bac : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.bac.toString())),
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " Nom : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.nom.toString())),
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " Pr\u00E9nom : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.prenom.toString())),
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " Option : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.option.toString())),
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " Alternant : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.alternant.toString())),
            React.createElement("div", { className: "flex" },
                " ",
                React.createElement("div", { className: "flex1" }, " LV2 : "),
                " ",
                React.createElement("div", { className: "flex2" },
                    " ",
                    this.props.row.lv2.toString()))));
    };
    return DisplayInfo;
}(React.Component));
...
var Info = /** @class */ (function () {
    function Info(code, bac, nom, prenom, option, alternant, lv2) {
        this.code = code;
        this.bac = bac;
        this.nom = nom;
        this.prenom = prenom;

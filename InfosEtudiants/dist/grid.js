...
var DisplayGrid = /** @class */ (function (_super) {
    ...
    DisplayGrid.prototype.labelDisplay = function (row) {
    ...
    DisplayGrid.prototype.rowType = function (row) {
        if (row.hasOwnProperty('codeModule'))
            return "mark";
        else if (row.hasOwnProperty('codeUnit'))
            return "module";
        else
            return "unit";
    };
    DisplayGrid.prototype.render = function () {
        ...
        return (React.createElement("tr", { className: this.rowType(this.props.row) },
            React.createElement("td", null, this.labelDisplay(this.props.row)),
            React.createElement("td", null, this.props.row.coefficient.toString().replace(".", ",")),
            React.createElement("td", { className: "nosp" }),
            React.createElement("td", { className: "nosp" }),
            React.createElement("td", { className: "nosp" }),
            React.createElement("td", null, this.props.row.value),
            React.createElement("td", { className: "nosp" })));
    };
    return DisplayGrid;
}(React.Component));
...
var Mark = /** @class */ (function (_super) {
    ...
    function Mark(code, coefficient, label, value, codeModule, optional, teacher, type) {
        var _this = _super.call(this, code, coefficient, label, value) || this;
        _this.codeModule = codeModule;
...
var Unit = /** @class */ (function (_super) {
    ...
    function Unit(code, coefficient, label, value) {
        return _super.call(this, code, coefficient, label, value) || this;
    }
    return Unit;
}(control_1.Control));
exports.Unit = Unit;

...
var DisplayAverageState = /** @class */ (function () {
    function DisplayAverageState(props) {
    }
    return DisplayAverageState;
}());
var DisplayAverage = /** @class */ (function (_super) {
    __extends(DisplayAverage, _super);
    function DisplayAverage(props) {
        var _this = _super.call(this, props) || this;
        _this.state = new DisplayAverageState(props);
        return _this;
    }
    // Calcul de la moyenne selon le tableau de notes récupéré (depuis grid.tsx ou display_grid.tsx)
    DisplayAverage.prototype.calculMoy = function () {
        var marks = this.props.marks, average = 0, coefficients = 0;
        for (var i = 0; i < marks.length; i++) {
            ...
            if (marks[i].module != "" || marks[i].module) {
                ...
                var relatedModule = marks.filter(function (m) { return m.label == marks[i].module; }), additionalCoefficent = relatedModule[0] ? relatedModule[0].coefficient : 1, value = marks[i].value * marks[i].coefficient * additionalCoefficent;
                average += value;
        ...
        var moy = (average /= coefficients).toString().replace(".", ","), displayed = moy.substring(0, moy.indexOf(",") + 3);
        return displayed.substring(displayed.length - 1) == "0" ? displayed.substring(0, displayed.length - 1) : displayed;
    };
    DisplayAverage.prototype.render = function () {
        var average = this.calculMoy();
        return (React.createElement("p", null, average));
    };
    return DisplayAverage;
}(React.Component));
exports.DisplayAverage = DisplayAverage;
...
var display_average_1 = __webpack_require__(14);
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", null,
                React.createElement("table", null,
                    ...
                    React.createElement("tbody", null, this.state.marks && this.state.marks.map(function (mark) {
                        // Pour chaque note dans la liste de notes, ajout d'une ligne dans la grille avec les valeurs de la note
                        return (React.createElement(display_grid_1.DisplayGrid, { mark: mark, marks: _this.state.marks, key: mark.code }));
                    }))),
                React.createElement("div", { className: "moy" },
                    React.createElement("p", null, "Moyenne g\u00E9n\u00E9rale"),
                    React.createElement(display_average_1.DisplayAverage, { marks: this.state.marks, key: "average" })))));
    };
    return Grid;
}(React.Component));
exports.Grid = Grid;
...
var React = __webpack_require__(2);
var display_average_1 = __webpack_require__(14);
var DisplayGridState = /** @class */ (function () {
...
var DisplayGrid = /** @class */ (function (_super) {
    ...
    DisplayGrid.prototype.displayMark = function (mark, marks) {
        var displayed = this.isModule(mark) ? marks.filter(function (m) { return m.module == mark.label; }) : [mark];
        return (React.createElement(display_average_1.DisplayAverage, { marks: displayed, key: mark.code }));
    };
    // Retourne true si mark.module est vide ou non défini, false sinon
    DisplayGrid.prototype.isModule = function (mark) {
        return mark.module == "" || !mark.module;
    };
    // Affiche le code si c'est un module
    DisplayGrid.prototype.labelDisplay = function (mark) {
        return this.isModule(mark) ? mark.code + " - " + mark.label : mark.label;
    };
    DisplayGrid.prototype.render = function () {
        ...
        return (React.createElement("tr", { className: this.assignClassName(this.props.mark) },
            React.createElement("td", null, this.labelDisplay(this.props.mark)),
            React.createElement("td", null, this.props.mark.coefficient.toString().replace(".", ",")),
            React.createElement("td", null, this.displayMark(this.props.mark, this.props.marks))));
    };
    return DisplayGrid;
}(React.Component));
